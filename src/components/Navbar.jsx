...
function Navbar() {
    ...
    return (
        <nav className='py-5 bg-blue-900 w-full fixed z-40'>
                    ...
                    <div className='text-slate-100 mt-5 lg:mt-0 gap-2 flex flex-col lg:flex-row items-center'>
                        {currentUser &&
                            <div className='flex flex-col lg:flex-row items-center gap-2'>
                                <Link>
                                    <div className='py-1 px-2 rounded font-medium hover:bg-blue-700 transition-colors duration-100'>
                                ...
                                <button onClick={() => {
                                    logout()
                                    setMenuIsOpen(false)
                                }} className='py-1 px-2 rounded font-medium hover:bg-blue-700 transition-colors duration-100'>
                                    Log Out
                                </button>
                            </div>
                        }
                ...
                <div className='text-slate-100 mt-5 hidden lg:mt-0  gap-2 lg:flex flex-col lg:flex-row items-center'>
                    {currentUser &&
                        <div className='gap-2 lg:flex flex-col lg:flex-row items-center'>
                            ...
                            <button onClick={logout} className='py-1 px-2 rounded font-medium hover:bg-blue-700 transition-colors duration-100'>
                                Log Out
                            </button>
                        </div>}
