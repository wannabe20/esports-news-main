            ...
            <div className='container grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-14 mx-auto pt-24 md:pt-32 pb-40'>
                {post && (
                    <div className="md:col-span-3">
                        <img 
                            className='w-full object-cover h-72 rounded mb-6' 
                            src={`${import.meta.env.VITE_SUPABASE_URL}/storage/v1/object/public/post-images/${post.img}`} 
                            alt="Post" 
                        />
                        <div className='flex gap-x-5 items-center mb-8'>
                            ...
                            <div>
                                ...
                                <h5 className='text-slate-600'>Posted {post.date}</h5>
                            </div>
                            ...
                            {post.uid === currentUser?.id && (
                                <>
                                    ...
                                    <button onClick={handleOpenModal} className='h-9 w-9 flex items-center justify-center rounded-full bg-blue-400'>
                                        <svg className='h-5 w-5' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
